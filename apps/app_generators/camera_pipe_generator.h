...
#ifndef CAMERA_PIPE_GENERATOR_H_
#define CAMERA_PIPE_GENERATOR_H_

#include <vector>

#include "Halide.h"
#include "tools/halide_trace_config.h"
...
public:
    ...
    void generate() {
        ...
        Func b_r, g_r("g_r"), b_gr, r_gr, b_gb, r_gb, r_b, g_b("g_b");
        ...
        Expr correction;
        correction = g_gr(x, y) - avg(g_r(x - 1, y), g_r(x, y));
...
void CameraPipe::generate() {
    ...
    processed.set_estimates({{0, 2560}, {0, 1920}, {0, 3}});
...
#endif // CAMERA_PIPE_GENERATOR_H_
