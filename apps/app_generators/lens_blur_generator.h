...
public:
    ...
    // Output<Buffer<float>> temp{"temp", 2};
    // Output<Buffer<int>> temp1{"temp1", 2};
    // Output<Buffer<int>> temp2{"temp2", 3};
    ...
    void generate() {
        ...
        // temp2(x, y, z) = sample_u;
        // temp(x, y) = random_float();
        // temp1(x, y) = sample_u;
        // temp2(x, y, z) = sample_v;
        ...
        // temp.set_estimates({{0, 192}, {0, 320}});
        // temp1.set_estimates({{0, 192}, {0, 320}});
        // temp2.set_estimates({{0, 192}, {0, 320}, {0, 3}});
